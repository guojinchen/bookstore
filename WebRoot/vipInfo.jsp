...
<body>
	...
	<input type="hidden" name="vips.passwords" value="${vips.passwords }"/>
<input type="hidden" name="vips.vipId" value="${vips.vipId }"/>	
	...
	<td><a style="height:20px;width:40px; font-size: 14px" href="delvip.action?vips.vipId=${s.vipId }">删除</a><a style="height:20px;width:40px; font-size: 14px" href="updatevip.action?vips.vipId=${s.vipId }">更新</a></td>
	</tr>
	</c:forEach>

	</table>
			<a href="viewvip.action?page=${pager.currentPage-1 }">上一页</a><a href="viewvip.action?page=${pager.currentPage+1 }">下一页</a>
		</div>
