...
function search(){
  ...
  <tr>
  <td colspan="2">   <p style="font-size: 36px">添加书籍信息</p> </td>
  </tr>
  <tr>
  <td>
         <label><strong>原价&nbsp;&nbsp;&nbsp;&nbsp;：</strong></label>  <input type="text" name="books.price" /><br/><br/>
        <label><strong>出版社&nbsp;&nbsp;：</strong></label>  <input type="text" name="books.publisher" /><br/><br/>
        <label><strong>出版时间：</strong></label>   <input type="text" onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)" name="books.publishtime" /><br/><br/>
        <label><strong>总数量&nbsp;&nbsp;：</strong></label>  <input type="text" name="books.allsum" /><br/><br/>
       <label><strong>已销售&nbsp;&nbsp;：</strong></label> <input type="text" name="books.sellsum" /><br/><br/>
      <label><strong>字数&nbsp;&nbsp;&nbsp;&nbsp;：</strong></label> <input type="text" name="books.words"/><br/><br/>
      

  </td>
  <td>
     <label><strong>书名&nbsp;&nbsp;：</strong></label><input type="text" name="books.bookName"/><br/><br/>
     <label><strong>作者&nbsp;&nbsp;：</strong></label> <input type="text" name="books.bookAuthor" /><br/><br/>
     <label><strong>总页数：</strong></label><input type="text" name="books.bookPages"/><br/><br/>
     <label><strong>类型&nbsp;&nbsp;：</strong></label> 
     <select id="b" name="btype">
     <option >请选择</option>
       <c:forEach items="${applicationScope.type}" var="s">
     <option value="${s.booktypeId}">${s.booktypeName}</option>
     </c:forEach>
  ...
  <label><strong>作者简介：</strong></label>  <textarea rows="10" cols="100" name="books.authorInfo" > 
     请在这里添加作者简介
      </textarea><br/><br/>
  </td>
  </tr>
