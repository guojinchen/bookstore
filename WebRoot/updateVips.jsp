...
<div class="title_box">特别推荐</div>  
 ...
 <div class="center_content">
   	...
   	<div class="center_title_bar">修改个人信息</div>
    	...
    	<div class="prod_box_big">
            ...
            <div class="center_prod_box_big">            
              	...
              	<div >以下为必填项：</div>
                    <form action="relupdatevips.action" id="myform" onsubmit="return validater()" method="post"> 
                    <input type="hidden" id="vipId" name="vips.vipId" value="${vips.vipId }">
                    <div class="form_row">
                    <label class="contact"><strong>*用户名:</strong></label>
                    <input id="username" name="vips.username" type="text" class="contact_input" value="${vips.username }"   readonly="readonly"/>用户名不能修改
                    </div>  

                    <div class="form_row">
                    <label class="contact"><strong>*密码:</strong></label>
                    <input id="password" name="vips.passwords" type="text" class="contact_input"  value="${vips.passwords }"/>长度不少于八位
                    </div>


                    <div class="form_row">
                    <label class="contact"><strong>*确认密码:</strong></label>
                    <input id="repassword"  type="text" class="contact_input" value="${vips.passwords }"/>长度不少于八位
                    </div>
                    
                    <div class="form_row">
                    <label class="contact"><strong>*密保问题:</strong></label>
                    <input id="questions" name="vips.question" type="text" class="contact_input"  value="${vips.question }"/>
                    </div>


                    <div class="form_row">
                    <label class="contact"><strong>*密保答案:</strong></label>
                     <input id="answers" name="vips.answer" type="text" class="contact_input"  value="${vips.answer }"/>
                    </div><br>
				<div>以下为选填项</div>
                    <div class="form_row">
                    <label class="contact"><strong>姓名:</strong></label>
                    <input type="text" name="vips.realname" class="contact_input" value="${vips.realname }"/>
                    </div>  
                    
                    <div class="form_row">
                    <label class="contact"><strong>性别:</strong></label>
                  <input type="radio" name="vips.sex"  value="男"  ${vips.sex=='男'?'checked':''}/>男
        <input type="radio" name="vips.sex" value="女" ${vips.sex=='女'?'checked':''}/>女<br/><br/>
        <%--女
                    
                    
                    
                    <input  type="radio" name="vips.sex" value="男" checked="checked"/>男
                    <input type="radio" name="vips.sex" value="女" />女
                    --%></div>  
                    
                    <div class="form_row">
                    <label class="contact"><strong>年龄:</strong></label>
                    <input type="text" name="vips.age" class="contact_input" value="${vips.age }"/>
                    </div> 
                    
                    <div class="form_row">
                    <label class="contact"><strong>手机号:</strong></label>
                    <input type="text" name="vips.mobilephone" class="contact_input" value="${vips.mobilephone }"/>
                    </div>   
                    
                    <div class="form_row">
                    <label class="contact"><strong>Email:</strong></label>
                    <input type="text" id="myemail" name="vips.email"class="contact_input" value="${vips.email }"/>eg:123456@qq.com
                    </div>  
                    
                    <div class="form_row">
                    <label class="contact"><strong>QQ:</strong></label>
                    <input type="text" name="vips.qq" class="contact_input" value="${vips.qq }"/>
                    </div>  
                    
                    <div class="form_row">
                    <label class="contact"><strong>住址:</strong></label>
                    <input type="text" name="vips.address" class="contact_input"  value="${vips.address }"/>
                    <input type="hidden" name="vips.registertime" value="${vips.registertime}"/>
                    </div><%--  
                             
                    <div class="form_row">
                    <label class="contact"><strong>修改注册时间:</strong></label>
                  <input  name="vips.registertime" type="text" onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)"   value="${vips.registertime}" />
                    
                    </div>      
                                
                                     
                    --%><div class="form_row">
                    <input type="button" class="contact_input" value="修改" onclick="submitform()"/></div>      
                  </form>      
                </div> 
