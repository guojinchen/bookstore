...
function search(){
  ...
  <tr>
  <td colspan="2">   <p style="font-size: 36px">更改订单状态</p> </td>
  </tr>
  <tr>
  <td>
 <label><strong>订单号&nbsp;&nbsp;：</strong></label> <input type="text" value="${orders.orderId }" name="orders.orderId"><br/><br/>
 <label><strong>下单时间：</strong></label> <input type="text" value="${orders.overTime}" name="orders.overTime"><br/><br/>
 <label><strong>会员ID：</strong></label> <input type="text" value="${orders.vips.vipId}" name="orders.vips.vipId"><br/><br/>
        <label><strong>付款类型：</strong></label>  <input type="text" name="orders.payType" value="${orders.payType}"/><br/><br/>
  ...
  <td>
   <label><strong>收货人地址：</strong></label>   <input type="text" name="orders.receiverAddress"value="${orders.receiverAddress }"/><br/><br/>
      ...
      <label><strong>联系电话：</strong></label> <input type="text" name="orders.receiverTelephone" value="${orders.receiverTelephone }"/><br/><br/>
       <label><strong>总金额：</strong></label> <input type="text" name="orders.totalPrice" value="${orders.totalPrice }"/><br/><br/>
  </td>
 </tr>
 <tr>
 <td colspan="2">
 
  <label><strong>是否存档：</strong></label><input type="radio" name="orders.isSave" value="是" ${orders.isSave=='是'?'checked':''}/>是
       <input type="radio" name="orders.isSave" value="否" ${orders.isSave=='否'?'checked':''}/>否<br/><br/>
        <label><strong>是否付款：</strong></label><input type="radio" name="orders.isPay" value="是"  ${orders.isPay=='是'?'checked':''}/>是
        <input type="radio" name="orders.isPay" value="否"  ${orders.isPay=='否'?'checked':''}/>否<br/><br/>
         <label><strong>是否发货：</strong></label><input type="radio" name="orders.isSendbook" value="是"  ${orders.isSendbook=='是'?'checked':''}/>是
          <input type="radio" name="orders.isSendbook" value="否"   ${orders.isSendbook=='否'?'checked':''}/>否<br/><br/>
        <label><strong>是否收货：</strong></label><input type="radio" name="orders.isAffirm" value="是"  ${orders.isAffirm=='是'?'checked':''}/>是
        <input type="radio" name="orders.isAffirm" value="否" ${orders.isAffirm=='否'?'checked':''}/>否<br/><br/>
