...
<div class="title_box">特别推荐</div>  
   ...
   <!--scrolling images -->
           		<%--<div class="oferta">
                	<img src="images/xiaofufanfan.jpg" width="563" height="144" border="0" class="oferta_img" alt="" title="" />
                </div>
   
   
   	--%><div class="center_title_bar">出版社下的书籍</div>
   	
   		<c:forEach items="${list}" var="s">		    
		    <div class="prod_box">
	            <div class="center_prod_box">            
	                 <div class="product_title"><a href="details.action?book.bookId=${s.bookId}">${s.bookName }</a></div>
	                 <div class="product_img"><a href="details.action?book.bookId=${s.bookId}"><img src="${s.bookImage}" alt="" title="" border="0" style="width:60px;height:80px;"/></a></div>
 ...
 <div class="right_content">
     ...
     <form name="myform" action="find.action">
		<input type="text" name="book.bookName" class="newsletter_input" />
