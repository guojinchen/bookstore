...
<div class="title_box">特别推荐</div>  
   ...
   <table align="center" style="text-align: center ;width: 400px" class="lang_text">
   <tr>
   <th>订单号</th>
   <th>下单时间</th>
   <th>操作</th>
...
<tr>
<td>
<a href="myorderdetail.action?orders.orderId=${s.orderId }">${s.orderId }</a>
</td>
<td>
<a href="myorderdetail.action?orders.orderId=${s.orderId }">${s.overTime }</a>
</td>
<td><a href="updatemyorder.action?orders.orderId=${s.orderId }">修改</a> &nbsp;&nbsp; <a href="delmyorder.action?orders.orderId=${s.orderId }">取消</a> </td>
</tr>
</c:forEach>
   </table>
