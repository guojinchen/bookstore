...
<div class="title_box">特别推荐</div>  
   ...
   <div class="center_content">
     <p style="font-size: 24px;color: blue">订单详细信息</p> 
<table align="center" bgcolor="#cccccc" >
<tr>
<td>
<label>订单号&nbsp;&nbsp;：</label> ${orders.orderId }<br/><br/>
 <label>下单时间：</label>${orders.overTime}<br/><br/>
 <label>会员ID：</label> ${orders.vips.vipId}<br/><br/>
        <label>付款类型</label> ${orders.payType}<br/><br/>
        <label>邮政编码：</label> ${orders.postcode}<br/><br/>
</td>
 <td>
 <label>收货人地址：</label>  ${orders.receiverAddress }<br/><br/>
        <label>收货邮箱：</label> ${orders.receiverEmail}<br/><br/>
       <label>收货人姓名：</label> ${orders.receiverName}<br/><br/>
      <label>联系电话：</label> ${orders.receiverTelephone }<br/><br/>
       <label>总金额：</label> ${orders.totalPrice }<br/><br/>
 </td>
 </tr>
