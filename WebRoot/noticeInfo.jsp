...
<body>
	...
	<table border="1" style="border-style:inset;border-color: buttontext">
	<tr>
	<th>公告时间</th>
	<th>公告内容</th>
	<th>操作</th>
	...
	<tr>
	<td>${s.noticeTime }</td>
	<td>${s.noticeContent}</td>
	<td><a style="height:20px;width:40px; font-size: 14px" href="delnotice.action?notice.noticeId=${s.noticeId }">删除</a><a style="height:20px;width:40px; font-size: 14px" ></a><a style="height:20px;width:40px; font-size: 14px" href="updatenotice.action?notice.noticeId=${s.noticeId }">更新</a><a style="height:20px;width:40px; font-size: 14px" ></a></td>
	</tr>
	</c:forEach>

	</table>
			<a href="viewnotice.action?page=${pager.currentPage-1 }">上一页</a><a href="viewnotice.action?page=${pager.currentPage+1 }">下一页</a>
		</div>
