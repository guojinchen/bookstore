...
function search(){
  ...
  <tr>
  <td colspan="2">   <p style="font-size: 36px">添加公告信息</p> </td>
  </tr>
  <tr>
  <td>
			<input type="hidden" name="notice.noticeId" />	
        <label><strong>公告时间：</strong></label>   <input type="text" onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)" name="notice.noticeTime" /><br/><br/>
        <label><strong>公告内容：&nbsp;&nbsp;：</strong></label>  <textarea cols="10" rows="3"name="notice.noticeContent">请在这里添加公告信息</textarea>  <br/><br/>
