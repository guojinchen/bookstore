...
function search(){
  ...
  <body>
	...
	<div class="box">
	  ...
	  <form action="relupdatenotice.action" method="post">
  <table align="center" border="1" width="900" style="text-align: center">

  <tr>
  <td colspan="2">   <p style="font-size: 36px">修改公告信息</p> </td>
  </tr>
  <tr>
  <td>
			<input type="hidden" name="notice.noticeId" value="${notice.noticeId }"/>	
        <label><strong>公告时间：</strong></label>   <input type="text" onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)" name="notice.noticeTime" value="${notice.noticeTime }"/><br/><br/>
        <label><strong>公告内容：&nbsp;&nbsp;：</strong></label>  <textarea cols="10" rows="3"name="notice.noticeContent">${notice.noticeContent }</textarea>  <br/><br/>
