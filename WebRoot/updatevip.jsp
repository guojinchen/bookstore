...
function search(){
  ...
  <body>
	...
	<div class="box">
	  ...
	  <form action="relupdatevip.action" method="post">
  <table align="center" border="1" width="900" style="text-align: center">

  <tr>
  <td colspan="2">   <p style="font-size: 36px">修改会员信息</p> </td>
  </tr>
  <tr>
  <td>
			<input type="hidden" name="vips.vipId" value="${vips.vipId }"/>	
         <label><strong>用户名&nbsp;&nbsp;&nbsp;&nbsp;：</strong></label>  <input type="text" name="vips.username" value="${vips.username }"/><br/><br/>
           <label><strong>密码&nbsp;&nbsp;&nbsp;&nbsp;：</strong></label> <input type="text" name="vips.passwords" value="${vips.passwords }"/><br/><br/>
        ...
        <label><strong>注册时间：</strong></label>   <input type="text" onfocus="SelectDate(this,'yyyy-MM-dd hh:mm:ss',0,-150)" name="vips.registertime"  value="${vips.registertime }" /><br/><br/>
        <label><strong>密保问题&nbsp;&nbsp;：</strong></label>  <input type="text" name="vips.question" value="${vips.question }" /><br/><br/>
       <label><strong>密保答案&nbsp;&nbsp;：</strong></label> <input type="text" name="vips.answer"  value="${vips.answer }"/><br/><br/>
    
      

  </td>
  <td>
     <label><strong>年龄&nbsp;&nbsp;：</strong></label><input type="text" name="vips.age"value="${vips.age }"/><br/><br/>
     <label><strong>QQ&nbsp;&nbsp;：</strong></label> <input type="text" name="vips.qq" value="${vips.qq }"/><br/><br/>
     <label><strong>联系电话</strong></label><input type="text" name="vips.mobilephone" value="${vips.mobilephone }"/><br/><br/>
       <label><strong>姓名&nbsp;&nbsp;&nbsp;&nbsp;：</strong></label> <input type="text" name="vips.realname"value="${vips.realname }"/><br/><br/>
     <label><strong>邮箱&nbsp;&nbsp;：</strong></label>   <input type="text" name="vips.email" value="${vips.email }"/><br/><br/>
     <label><strong>地址&nbsp;&nbsp;：</strong></label> <input type="text" name="vips.address"value="${vips.address }" /><br/><br/>
  </td>
  </tr>
  <tr>
